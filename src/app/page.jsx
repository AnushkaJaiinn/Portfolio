...
export default function HomePage() {
    ...
    return (
        <>
            ...
            {/* ═══════════════════════════════════════════════════════════════
                POSITIONING STATEMENT CARD + INLINE CTA
            ═══════════════════════════════════════════════════════════════ */}
            <section id="apply-section" className="py-16 md:py-20 bg-gradient-to-br from-anushka-50 via-rose-50 to-cream scroll-mt-8">
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        {/* CTA Button - Right after positioning card */}
